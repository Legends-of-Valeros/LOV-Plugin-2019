...
public class Trigger {
    ...
    public static class TriggerBuilder {
        ...
        public TriggerBuilder condition(Condition.ConditionBuilder condition) {
        ...
        public TriggerBuilder conditions(Collection<? extends Condition.ConditionBuilder> conditions) {
            if (this.conditions == null)
                this.conditions = new ArrayList<>();
