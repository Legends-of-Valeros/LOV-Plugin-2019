...
public class MessageUtil {
  ...
  public static void sendInfo(CommandSender sender, BaseComponent[] message) {
    sender.spigot()
        .sendMessage(prepend(message, new TextBuilder("[i] ").color(ChatColor.YELLOW).create()));
  }
  ...
  public static void sendUpdate(CommandSender sender, BaseComponent[] message) {
    sender.spigot()
        .sendMessage(prepend(message, new TextBuilder("[!] ").color(ChatColor.AQUA).create()));
  }
  ...
  public static void sendError(CommandSender sender, BaseComponent[] message) {
    sender.spigot()
        .sendMessage(prepend(message, new TextBuilder("[*] ").color(ChatColor.RED).create()));
  }
  ...
  public static void sendDebug(CommandSender sender, BaseComponent[] message) {
    sender.spigot()
        .sendMessage(prepend(message, new TextBuilder("[d] ").color(ChatColor.GOLD).create()));
  }
  ...
  private static void sendException(String module, CommandSender sender, Throwable th,
      boolean log) {
    ...
    BaseComponent[] bc = new TextBuilder(
        "[X" + (module != null ? ":" + module : "") + "] " + message).color(ChatColor.DARK_RED)
        .create();
   ...
   * @param sender
   */
  private static void sendExceptionToDiscord(String module, CommandSender sender, Throwable th,
