...
import com.legendsofvaleros.modules.combatengine.statuseffects.Blindness;
 ...
 */
public class Blind extends SkillEffect<Double> {
	public static final long MILLIS_PER_LEVEL = 1000;

	private static final String BASE_UI_NAME = "Blind";

	public Blind() throws IllegalArgumentException {
		super("Blind", 1, Integer.MAX_VALUE, false, InterruptionCause.DEATH);
	}
