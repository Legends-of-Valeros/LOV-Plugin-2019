 ...
 */
public class SkillFlashOfRecovery extends Skill {

  public SkillFlashOfRecovery(String id, Type type, EntityClass pclass, int[] levelCosts, int[] powerCost, double[] cooldown,
