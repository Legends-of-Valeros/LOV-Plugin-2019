 ...
 */
public class SkillHealingLight extends Skill {

  public SkillHealingLight(String id, Type type, EntityClass pclass, int[] levelCosts, int[] powerCost, double[] cooldown,
