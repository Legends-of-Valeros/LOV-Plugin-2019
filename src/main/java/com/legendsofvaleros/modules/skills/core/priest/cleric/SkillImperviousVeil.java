 ...
 */
public class SkillImperviousVeil extends Skill {

  public SkillImperviousVeil(String id, Type type, EntityClass pclass, int[] levelCosts, int[] powerCost, double[] cooldown,
