 ...
 */
public class SkillBenevolence extends Skill {

  public SkillBenevolence(String id, Type type, EntityClass pclass, int[] levelCosts, int[] powerCost, double[] cooldown,
