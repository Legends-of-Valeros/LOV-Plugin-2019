 ...
 */
public class SkillPsychicScream extends Skill {

  public SkillPsychicScream(String id, Type type, EntityClass pclass, int[] levelCosts, int[] powerCost, double[] cooldown,
