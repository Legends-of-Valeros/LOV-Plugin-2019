 ...
 */
public class SkillShieldMantra extends Skill {

  public SkillShieldMantra(String id, Type type, EntityClass pclass, int[] levelCosts, int[] powerCost, double[] cooldown,
