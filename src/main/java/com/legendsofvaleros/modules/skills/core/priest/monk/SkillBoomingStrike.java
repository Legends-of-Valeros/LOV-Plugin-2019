 ...
 */
public class SkillBoomingStrike extends Skill {

  public SkillBoomingStrike(String id, Type type, EntityClass pclass, int[] levelCosts, int[] powerCost, double[] cooldown,
