 ...
 */
public class SkillPurification extends Skill {

  public SkillPurification(String id, Type type, EntityClass pclass, int[] levelCosts, int[] powerCost, double[] cooldown,
