...
public class SkillTransformSelf extends Skill {
  ...
  public SkillTransformSelf() {
    super(ID, Type.SELF, EntityClass.MAGE, LEVELS, COST, COOLDOWN, DESCRIPTION);
  }
  ...
  public boolean onSkillUse(World world, CombatEntity ce, int level) {
    ...
    Characters.getInstance().getSkillEffectManager().getSkillEffect("Polymorph")
        .apply(ce.getLivingEntity(), ce.getLivingEntity(), getEarliest(MORPH_LEVEL, level));
    return true;
  }
}