 ...
 */
public class SkillFieryPromise extends Skill {

  public SkillFieryPromise(String id, Type type, EntityClass pclass, int[] levelCosts, int[] powerCost, double[] cooldown,
