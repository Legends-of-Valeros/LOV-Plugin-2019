...
public class InventoryManager implements Listener {
	...
	public static boolean hasFixedItem(int slot) { return fixedItems.containsKey(slot); }
	/**
	 * 40 - 45 = Crafting slots
	 * @param slot
	 * @param item
	 */
	public static void addFixedItem(int slot, InventoryItem item) { fixedItems.put(slot, item); }
