...
public class GUI {
	...
	public InventoryView getView(Player p) { return views.get(p.getUniqueId()); }
	...
	public ISlotAction getSlot(int x, int y) { return getSlot(x + y * columns); }
	 ...
	 * @return The GUI instance
	 */
	public GUI slot(int slot, Material item, ISlotAction action) { return slot(slot, new ItemStack(item), action); }
	 ...
	 * @return The GUI instance
	 */
	public GUI slot(int x, int y, Material item, ISlotAction action) { return slot(x, y, new ItemStack(item), action); }
	 ...
	 * @return The GUI instance
	 */
	public GUI slot(int x, int y, ItemStack item, ISlotAction action) { return slot(x + y * columns, item, action); }
	...
	public GUI setItem(int x, int y, ItemStack item) { setItem(x + y * columns, item); return this; }
