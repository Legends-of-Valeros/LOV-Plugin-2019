...
public class ItemBuilder {
	...
	public Material getMaterial() { return stack.getType(); }
	...
	public HashMap<String, Object> getTags() { return nbt; }

	public ItemBuilder(Material material) { this(new ItemStack(material)); }
	public ItemBuilder(Material material, int i) { this(new ItemStack(material, 1, (short)i)); }
	...
	public ItemBuilder clearLore() { lore.clear(); return this; }
	...
	public ItemBuilder clearFlags() { flags.clear(); return this; }
